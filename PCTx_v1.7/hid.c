...
/******************************************************************************
 * Function:        void HIDGetReportHandler(void)
 *
 * PreCondition:    None
 *
 * Input:           None
 ...
 * Side Effects:    None
 *
 * Overview:       	Called on receiving a Setup packet with a Get_Report request.
 * 					Extracts the report type and the report ID of the report
 * 					the device will send in the Data stage of the transfer.
 * 					Calls a function to provide the data.	
 *
 * Note:            None
 *****************************************************************************/
...
/******************************************************************************
 * Function:        void HIDSetReportHandler(void)
 *
 * PreCondition:    None
 *
 * Input:           None
 ...
 * Side Effects:    None
 *
 * Overview:       	Called on receiving a Setup packet with a Set_Report request.
 * 					Extracts the report type and the report ID of the report
 * 					the host will send in the Data stage of the transfer.
 * 					Places the report type and report ID in out_report_status.	
 *
 * Note:            None
 *****************************************************************************/
